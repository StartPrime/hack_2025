	...
	return (
		<div className='min-h-screen py-8'>
			<Container>
				...
				{passwordUser && (
					<div className='fixed inset-0 backdrop-blur bg-black/50 flex items-center justify-center p-4 z-50'>
						<div className='bg-white rounded-lg shadow-xl w-full max-w-md border border-primary'>
							<div className='p-6'>
								<h2 className='text-xl font-bold text-gray-800 mb-4'>
									Смена пароля для{' '}
							...
							<div className='bg-gray-50 px-6 py-4 flex justify-end space-x-3 rounded-lg'>
								<button
